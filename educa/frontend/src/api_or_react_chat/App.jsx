    ...
    <>
      <div className="container">
        ...
        <div className="send-section">
            ...
            <button className="send-button" onClick={()=>client.publish(topic, "{'user1':'"+global_id1+"', 'user2':'"+global_id2+"', 'token':'', 'text': '"+global_texter+"'}")}>Отправить</button>
        </div>
      </div>
    </>
  )
